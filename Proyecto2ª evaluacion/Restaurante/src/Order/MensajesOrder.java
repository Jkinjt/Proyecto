...
public class MensajesOrder {
	...
	public static void insertarClien() {
		System.out.println("+-------------------------+");
		System.out.println("| Inserte un nuevo cliente|");
		System.out.println("+-------------------------+");
	}
	...
	public static void clientenombre() {
		System.out.println("+---------------------------------+");
		System.out.println("| Inserte un nombre de un cliente |");
		System.out.println("+---------------------------------+");
	}
	public static void clientedni() {
		System.out.println("+------------------------------+");
		System.out.println("| Inserte el dni de un cliente |");
		System.out.println("+------------------------------+");
	}
	public static void nclientenombre() {
		System.out.println("+--------------------------+");
		System.out.println("| Inserte un nuevo cliente |");
		System.out.println("+--------------------------+");
	}
	...
	public static void insertarproductos() {
		System.out.println("+-------------------------+");
		System.out.println("|Introduzca los productos |");
		System.out.println("+-------------------------+");
	}
	
	
	public static void menupdro() {
		System.out.println("+---------------------+");
	...
	public static void maddr() {
		System.out.println("+----------------------+");
		System.out.println("| Direccion modificada |");
		System.out.println("+----------------------+");
	}
	public static void insertardirecc() {
		System.out.println("+-------------------------+");
